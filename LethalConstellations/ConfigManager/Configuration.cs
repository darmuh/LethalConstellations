...
namespace Constellations.ConfigManager
{
    public static class Configuration
    {
        ...
        public static void BindConfigSettings()
        {
            ...
            //Customization
            ConstellationsWord = MakeString(MainConfig, "Customization", "ConstellationsWord", "Constellations", "Use this config item to change any instance of the word 'Constellations' with your own specific word.\nThe terminal keyword will use this one!!!");
            ConstellationsOtherText = MakeString(MainConfig, "Customization", "ConstellationsOtherText", "Constellations\nTo display Constellations available for routing", "text displayed in the 'Other' command output regarding the constellation menu command");
            ConstellationsInfoText = MakeString(MainConfig, "Customization", "ConstellationsInfoText", "Use this command to display Constellations available for routing.\nRoute to a specific constellation to update your moons listing!\r\n\r\n", "Use this config item to change any instance of the word 'Constellation' with your own specific word");

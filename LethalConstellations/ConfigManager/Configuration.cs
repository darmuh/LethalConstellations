...
namespace LethalConstellations.ConfigManager
{
    public static class Configuration
    {
        ...
        public static ConfigEntry<string> ExitPage {  get; internal set; }
        ...
        public static void BindConfigSettings()
        {
            ...
            ExitPage = MakeString(Plugin.instance.Config, "Menu Settings", "ExitPage", "home", "Will load the given keyword on menu exit");
